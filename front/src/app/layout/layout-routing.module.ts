...
const routes: Routes = [
    {
        ...
        children: [
            ...
            { path: 'pedido', loadChildren: '../components/cliente/cliente-edicao/cliente-edicao.module#ClienteEdicaoModule' },
            { path: 'pedido/:id', loadChildren: '../components/cliente/cliente-edicao/cliente-edicao.module#ClienteEdicaoModule' },
            { path: 'pedido-consulta', loadChildren: '../components/pedido/pedido-consulta/pedido-consulta.module#PedidoConsultaModule' },
